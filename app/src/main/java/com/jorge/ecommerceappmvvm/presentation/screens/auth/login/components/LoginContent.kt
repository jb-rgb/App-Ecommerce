...
import com.jorge.ecommerceappmvvm.presentation.screens.auth.login.LoginViewModel
import com.jorge.ecommerceappmvvm.ui.theme.Blue700
    ...
    Box(modifier = Modifier) {
        Image(
            ...
            colorFilter = ColorFilter.colorMatrix(ColorMatrix()
                .apply { setToScale(0.6f, 0.6f, 0.6f, 1f) })
        )
        Column(
